...
3.  **Diagnostics**: Confirmed convergence using **Trace Plots** and the **Gelman-Rubin statistic** (PSRF ≈ 1.0). Validated model fit via **Posterior Predictive Checks** (Bayesian p-value ≈ 0.52).
